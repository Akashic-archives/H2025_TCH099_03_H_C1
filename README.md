...
```
pour installer les prérequis et
```shell
sudo cp -r * /var/www/html/
```
pour copier les fichiers à la bonne place.
Il manque quelques étapes tel SSL et le DNS, mais je vous laisse le faire comme vous voulez.
